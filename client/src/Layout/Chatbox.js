  ...
  const [Notee,setNote]= useState(false);
        ...
        const textQuery= async (text)=>{
            ...
            try{
                ...
                const response = await axios.post('/dialogflow/chatbot',textQueryVariables);
                    ...
                    <div>
                            ...
                            <div class="chat-msg user">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="mx-10">
                                        <a href="#" class="text-dark hover-primary font-weight-bold">Edubot</a>
                                    </div>
                                </div>
		...
		<div class="chat-box">
            <div class="chat-box-header p-15 d-flex justify-content-between align-items-center">
                ...
                <div class="text-center flex-grow-1">
                    <div class="text-dark font-size-18">Edubot</div>
                    <div>
